...
const LeftSideBar = () => {
	return (
		<section className="flex p-0 md:p-4 md:pr-0">
			<div
				className="flex card-container rounded-none md:rounded-xl py-2 pl-2 pr-0 
				md:pl-2 md:p-4 md:pr-0 md:border-r-0
				border-r border-r-neutral-200"
			>
				<div className="grow flex flex-col justify-between gap-3 md:gap-4 overflow-auto pr-2">
					{/* Top */}
